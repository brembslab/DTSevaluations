...
**Recording:** [`r paste(URIs$recording)`](https://doi.org/`r paste(URIs$recording)`)
**Analysis:** [`r paste(URIs$analysis)`](https://doi.org/`r paste(URIs$analysis)`)
**Datamodel:** [`r paste(URIs$datamodel)`](https://doi.org/`r paste(URIs$datamodel)`)
