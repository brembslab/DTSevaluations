...
```{r flybaseid_match, echo=FALSE, results='asis'}
if (!flybaseid_match) {cat("**WARNING: flybaseids in yaml file does not match with individual xml files. Please check each file manually.**")
}
```
