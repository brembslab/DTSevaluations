...
groupings=c("test","exp","experimental") # only do statistics if the user has specified which groups are which

if(NofGroups==3 & any(groupings %in% groupdescriptions))
{
  Count=1
  Control=list()
  Exp=list()
...
fpz4=out2[1]
#Power and likelihood ratio: NB for two sided test, need 2*y0
LR1=out1[5]/(2*out1[3])        #likelihood ratio (Hi1/H0) =y1/2*y0
LR2=out2[5]/(2*out2[3])
#make tidy table of results
