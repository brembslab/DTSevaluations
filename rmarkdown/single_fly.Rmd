...
## Plot flight pauses
span <- 41 ##Sets the span for the rolling variance
threshold <- 200 ##Sets threshold for low variance
min_length <- 10 ##Sets the minimum length considered a flight pause
...
for (y in direc_vec) {
  ...
  ratio <- length(low)/5 ##Finds bottom 20% of variance
  low <- low[1:ratio]
...
#Makes a list of data.frames for working with further
