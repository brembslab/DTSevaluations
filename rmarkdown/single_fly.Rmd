...
<<<<<<< Updated upstream
**Fly description:** `r paste(fly$description)`;  **FlyBase ID: Male** `r if(exists("flyidmale")){hyperlinks.FBidsmale(flyidmale)}`  **X Female** `r if(exists("flyidfemale")){hyperlinks.FBidsfemale(flyidfemale)}`
=======
**Fly description:** `r paste(fly$description)`;  **FlyBase ID: Male** `r if(!is.null(singleflydata$fly$flybasemale)){hyperlinks.FBids(singleflydata$fly$flybasemale)}`  **X Female** `r if(!is.null(singleflydata$fly$flybasefemale)){hyperlinks.FBids(singleflydata$fly$flybasefemale)}`
>>>>>>> Stashed changes
