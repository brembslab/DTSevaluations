...
**Fly description:** `r paste(fly$description)`;  **FlyBase ID: Male** `r id_rescue(singleflydata$fly$flybasemale)`   **X Female** `r id_rescue(singleflydata$fly$flybasefemale)` 
