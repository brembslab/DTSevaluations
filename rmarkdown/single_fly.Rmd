...
**Recording:** [`r paste(singleflydata$URIs$recording)`](https://doi.org/`r paste(singleflydata$URIs$recording)`)
**Analysis:** [`r paste(singleflydata$URIs$analysis)`](https://doi.org/`r paste(singleflydata$URIs$analysis)`)
**Datamodel:** [`r paste(singleflydata$URIs$datamodel)`](https://doi.org/`r paste(singleflydata$URIs$datamodel)`)
