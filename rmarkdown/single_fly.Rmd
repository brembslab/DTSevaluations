...
```{r tracesheatmarked, eval=('yt' %in% sequence$type || 'sw' %in% sequence$type) , echo=FALSE, warning=FALSE, message=FALSE, error=FALSE, fig.align = "center", fig.height = 4, fig.width = 12}   

cat("\n## Interactive Time Traces (heated episodes marked)\n")
