...
{
  OMdataBefore_swapped=tempOMdata
} else {
  OMdataBefore_swapped[[as.character(flyname)]]=tempOMdata[[as.character(flyname)]]
}
```
...
{
  OMdataAfter_swapped=tempOMdata
} else {
  OMdataAfter_swapped[[as.character(flyname)]]=tempOMdata[[as.character(flyname)]]
}
```
