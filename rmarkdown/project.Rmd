...
if(NofGroups==2)
  {
        ...
        # plot two parameters with asterisks
...
for(x in 1:NofGroups)
  {
    ...
    PIprofile$category[PIprofile$category=="0 right_torque"]<-"Right torque"
    PIprofile$category[PIprofile$category=="0 left_torque"]<-"Left torque"
    PIprofile$category[PIprofile$category=="7 right_torque"]<-"Green punished right"
    PIprofile$category[PIprofile$category=="7 left_torque"]<-"Blue punished left"
    PIprofile$category[PIprofile$category=="8 right_torque"]<-"Blue punished right"
    PIprofile$category[PIprofile$category=="8 left_torque"]<-"Green punished left"
    PIprofile$category[PIprofile$category=="1 right_torque"]<-"Right torque"
    PIprofile$category[PIprofile$category=="1 left_torque"]<-"Left torque"
...
PIstatCombined$category[PIstatCombined$category=="0 right_torque"]<-"Right torque"
  PIstatCombined$category[PIstatCombined$category=="0 left_torque"]<-"Left torque"
  PIstatCombined$category[PIstatCombined$category=="7 right_torque"]<-"Green punished right"
  PIstatCombined$category[PIstatCombined$category=="7 left_torque"]<-"Blue punished left"
  PIstatCombined$category[PIstatCombined$category=="8 right_torque"]<-"Blue punished right"
  PIstatCombined$category[PIstatCombined$category=="8 left_torque"]<-"Green punished left"
  PIstatCombined$category[PIstatCombined$category=="1 right_torque"]<-"Right torque"
  PIstatCombined$category[PIstatCombined$category=="1 left_torque"]<-"Left torque"
