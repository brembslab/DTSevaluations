...
```{r SuperimposedHistograms, eval=(NofGroups==2 & ('fs' %in% sequence$type || 'color' %in% sequence$type)), echo=FALSE, warning=FALSE, message=FALSE, error=FALSE, fig.align = "center", fig.height = 6, fig.width = 8, comment=NA, results='asis'}    
