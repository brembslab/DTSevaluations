...
```{r PeriodHistogram, eval=('fs' %in% sequence$type || 'color' %in% sequence$type), echo=FALSE, warning=FALSE, message=FALSE, error=FALSE, fig.align = "center", fig.height = 12, fig.width = 8, comment=NA, results='asis'}   
...
## Performance Index barplot {.tabset .tabset-fade}


### Barplot 

```{r PIBarplot, eval=PIs, echo=FALSE, warning=FALSE, message=FALSE, error=FALSE, fig.align = "center", fig.height = len, fig.width = 8, comment=NA, results='asis'}
...
for(x in 1:NofGroups){
  ...
  y_axis_var = "PIs"
  PIbarplot = BarplotPI(y_axis_var)
  PIplots[[x]] = PIbarplot
  }
...
```{r PIBarplotNorm, eval=PIs, echo=FALSE, warning=FALSE, message=FALSE, error=FALSE, fig.align = "center", fig.height = len, fig.width = 8, comment=NA, results='asis'}
for(x in 1:NofGroups){
  PIprofile <- grouped.PIcombined[[x]] #get PIs (categories not used)
  y_axis_var = "norm"
  PIbarplot = BarplotPI(y_axis_var)
...
## Performance Index box&dotplot with and without notches{.tabset .tabset-fade}
...
for(x in 1:NofGroups){
  PIprofile <- grouped.PIcombined[[x]] #get PIs (categories not used)
  y_axis_var = "PIs"
  Boxplot = Boxnotch(y_axis_var, notch = TRUE)
  PIplots[[x]] = Boxplot
  }
...
### BoxWithNotch  Normalized



```{r BoxWithNotchnorm, eval=PIs, echo=FALSE, warning=FALSE, message=FALSE, error=FALSE, fig.align = "center", fig.height = len, fig.width = 8, comment=NA, results='asis'}
...
```{r BoxWithoutNotch, eval=PIs, echo=FALSE, warning=FALSE, message=FALSE, error=FALSE, fig.align = "center", fig.height = len, fig.width = 8, comment=NA, results='asis'}
for(x in 1:NofGroups){
  PIprofile <- grouped.PIcombined[[x]] #get PIs (categories not used)
  y_axis_var = "PIs"
  Boxplot = Boxnotch(y_axis_var, notch = FALSE)
  PIplots[[x]] = Boxplot
  }
...
### BoxWithoutNotch  Normalized


```{r BoxWithoutNotchnorm, eval=PIs, echo=FALSE, warning=FALSE, message=FALSE, error=FALSE, fig.align = "center", fig.height = len, fig.width = 8, comment=NA, results='asis'}
...
##  Performance Index Violin Plot {.tabset .tabset-fade}
...
for(x in 1:NofGroups){
  PIprofile <- grouped.PIcombined[[x]] #get PIs (categories not used)
  y_axis_var = "PIs"
  Violinplot = Violin(y_axis_var)
  PIplots[[x]] = Violinplot
  }
...
```{r Violinnorm, eval=PIs, echo=FALSE, warning=FALSE, message=FALSE, error=FALSE, fig.align = "center", fig.height = len, fig.width = 8, comment=NA, results='asis'}
for(x in 1:NofGroups){
  PIprofile <- grouped.PIcombined[[x]] #get PIs (categories not used)
  y_axis_var = "norm"
  Violinplot = Violin(y_axis_var)
...
```{r Utest, eval=(twogroupstats & NofGroups==2), echo=FALSE, warning=FALSE, message=FALSE, error=FALSE, fig.align = "center", fig.height = 6, fig.width = 8, comment=NA, results='asis'}
...
```{r Utestpooled, eval=(twogroupstats & PooledGroups), echo=FALSE, warning=FALSE, message=FALSE, error=FALSE, fig.align = "center", fig.height = 6, fig.width = 8, comment=NA, results='asis'}
...
```{r estimationstatspooled, eval=(twogroupstats & PooledGroups), echo=FALSE, warning=FALSE, message=FALSE, error=FALSE, fig.align = "center", fig.height = 6, fig.width = 8, comment=NA, results='asis'}
...
```{r splitviolinspooled, eval=(twogroupstats & PooledGroups), echo=FALSE, warning=FALSE, message=FALSE, error=FALSE, fig.align = "center", fig.height = 6, fig.width = 8, comment=NA, results='asis'}
