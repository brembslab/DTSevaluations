...
```{r dwelling, eval=twogroupstats, echo=FALSE, warning=FALSE, message=FALSE, error=FALSE, fig.align = "center", fig.height = 6, fig.width = 8, comment=NA, results='asis'}
   
for(x in 1:NofGroups)
  {
    dwellingtime <- grouped.dwellingtime[[x]]
    multiplot(plotlist = dwellingtime, cols=2) #flyhistos
}  
