...
```{r SuperimposedHistograms, eval=('fs' %in% sequence$type || 'color' %in% sequence$type), echo=FALSE, warning=FALSE, message=FALSE, error=FALSE, fig.align = "center", fig.height = 12, fig.width = 8, comment=NA, results='asis'}    
print(ggplot(supHistos, aes(x = a_pos, fill = group)) + 
