...
```{r TorqueHistogram, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE, error=FALSE, fig.align = "center", fig.height = 12, fig.width = 8, comment=NA, results='asis'}    

for(x in 1:NofGroups)
  {
    cat("<center><h4>",project.data[["resources"]][[x]][["title"]],"</h4></center>")
    trqhistos <- grouped.trqhistos[[x]]
    multiplot(plotlist = trqhistos, cols=round(NofPeriods/5)) #torquehistos
}  
```
