...
```{r Mean dwelling, eval=Dwell, echo=FALSE, warning=FALSE, message=FALSE, error=FALSE, fig.align = "center", fig.height = 5, fig.width = 5, comment=NA, results='asis'}
...
for(x in 1:NofGroups){
  ...
  dwellmeans[[x]]$fly = rep(flynames[,x][!is.na(flynames[,x])])
 ...
 girafe( ggobj = plot_grid(plotlist=dwellmeanplots, ncol = 1), width_svg = 3, height_svg = 3)
